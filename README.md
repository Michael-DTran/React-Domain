...
In this project I will be creating a React App and upload those files to a S3 Bucket to host the website and enable static hosting. Once uploaded I will be making a domain name service under Route 53 (R-53). Once registered I will create a certificate on AWS Certificate Manager (ACM) on a Cloudfront (CF) distribution to enable caching and https. Once those are all set up I will then verify that everthing works. By the end of the project I will have showcased a working website.
